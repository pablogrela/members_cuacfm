...
public class FeeProgramListTest extends WebSecurityConfigurationAware {
	...
	public void displayFeeProgramViewPageWithoutSiginInTest() throws Exception {
		mockMvc.perform(get("/feeProgramList")).andExpect(redirectedUrl("http://localhost/signin"));
	}
	...
	public void displaysInscriptionsTest() throws Exception {
		...
		mockMvc.perform(get("/feeProgramList").locale(Locale.ENGLISH).session(defaultSession)).andExpect(view().name("feeprogram/feeprogramlist"))
