...
public class BankRemittanceServiceTest extends WebSecurityConfigurationAware {
   ...
   public void SaveAndUpdateDirectDebitTest() throws UniqueException {
      ...
      BankAccount  bankAccount2 = new BankAccount(account2, "La CAIXA", "BSCHESMMXXX", "ES7620770024003102575766");
      ...
      accountService.update(account4, false);
      ...
      accountService.update(account5, false);
      ...
      accountService.update(account6, false);
      accounts.add(account6);

      FeeMember feeMember = new FeeMember("pay of 2015", 2015, Double.valueOf(20),
            DisplayDate.stringToDate2("2015-04-01"), DisplayDate.stringToDate2("2015-07-01"),
            "pay of 2016");
   ...
   public void bankRemittance() throws Exception {
      ...
      bankRemittanceService.managementDirectDebit(directDebit.getId());
