...
public class UserPayInscriptionServiceImpl implements UserPayInscriptionService {
   ...
   public List<UserPayInscription> findByUserPayInscriptionIds(Long accountId, Long payInscriptionId) {
      return userPayInscriptionRepository.findByUserPayInscriptionIds(accountId, payInscriptionId);
   }
   ...
   public List<UserPayInscription> getUserPayInscriptionListByAccountId(Long accountId) {
      return userPayInscriptionRepository.getUserPayInscriptionListByAccountId(accountId);
   }
