...
public class BookDTO {
	 ...
	 */
	public BookDTO(Long id, AccountDTO account, ElementDTO element, String description, String answer, Date dateCreate, Date dateStart,
	...
	public String toString() {
		return "BookDTO [id=" + id + ", account=" + account + ", element=" + element + ", description=" + description + ", answer=" + answer
