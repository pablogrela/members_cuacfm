...
public class TrainingForm {
   ...
   public Training createTraining(TrainingType trainingType) {
      ...
      return new Training(trainingType, getName(), DisplayDate.stringToDate(timeTraining + ","
            + dateTraining), DisplayDate.stringToDate(timeLimit + "," + dateLimit),
