 ...
 */
membersApp.controller('ReserveController', [ '$scope', 'ReserveService', function($scope, ReserveService) {
	$scope.sortType;
	$scope.search;
	...
	$scope.fetchAllReserves = function() {
		ReserveService.fetchAllReserves().then(function(data) {
			$scope.reserves = data;
	...
	$scope.fetchAllReservesClose = function() {
		ReserveService.fetchAllReservesClose().then(function(data) {
			$scope.reserves = data;
		}, function(errorResponse) {
			console.error('Error while fetching Users', errorResponse);
		});
